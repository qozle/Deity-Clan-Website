...
<html>
    ...
    <body>
        ...
        <div class="container players-cont">
            <h1 class="display-5 team-intro-heading-1">Deity<i class="team-intro-heading-2" style="color:#003391;">CLAN | </i><i class="team-intro-heading-2">Super Smash Bros</i></h1>
            <p class="team-intro-text">This is some filler text for the Super Smash Bros team.  I'd actually prefer that someone else write this because I'm not too sure what to say about the team, though I could probably come up with some generic copy if I had to.  Someone has to!  So what should go here?  Here's some example text from another e-sports website:
            <br><br>
            ...
            <div class='row players-row'>                
                ...
                <div class='col-sm-6 player-col'>
                    <a class='player-link' href='player-profiles/Ace-profile.php'>
