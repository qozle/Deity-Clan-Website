...
<html>
    <head>
        <title>Deity Clan | WolfEye</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 20px; text-align: center;">
            <div class="row">
                <div class="col">
                    <img class="calling-card" src="../img/team-members/Member_Calling_Card_Wolf_Eye3.png" alt="WolfEye">
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col">
                    <h3 class="info">WOLFEYE</h3>
            ...
            <hr>
             <div class="row">
                <div class="col">
                    <h3 class="info">KENDRIC CARDENAS</h3>
