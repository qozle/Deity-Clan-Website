...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 20px; text-align: center;">
            <div class="row">
                <div class="col">
                    <img class="calling-card" src="../img/team-members/Member_Calling_Card_Nukem3.png" alt="Nukem">
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col">
                    <h3 class="info">NUKEM</h3>
            ...
            <hr>
             <div class="row">
                <div class="col">
                    <h3 class="info">ALGELIS PASTOR</h3>
