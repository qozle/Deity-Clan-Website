...
<html>
    <head>
        <title>Deity Clan | Restart</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 20px; text-align: center;">
            <div class="row">
                <div class="col">
                    <img class="calling-card" src="../img/filler.png" alt="Restart">
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col">
                    <h3 class="info">RESTART</h3>
