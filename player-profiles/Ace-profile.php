...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 20px; text-align: center;">
            <div class="row">
                <div class="col">
                    <img class="calling-card" src="../img/filler.png" alt="Ace">
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col">
                    <h3 class="info">ACE</h3>
            ...
            <hr>
             <div class="row">
                <div class="col">
                    <h3 class="info">SUPER SMASH BROS</h3>
