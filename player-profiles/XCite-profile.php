...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 20px; text-align: center;">
            <div class="row">
                <div class="col">
                    <img class="calling-card" src="../img/team-members/Member_Calling_Card_Xcite3.png" alt="XCite">
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col">
                    <h3 class="info">XCITE</h3>
            ...
            <hr>
             <div class="row">
                <div class="col">
                    <h3 class="info">RONNY HILARIO</h3>
