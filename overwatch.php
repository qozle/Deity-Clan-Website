...
<html>
    <head>
        <title>Deity Clan | Overwatch</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container players-cont">
            <h1 class="display-5 team-intro-heading-1">Deity<i class="team-intro-heading-2" style="color:#003391;">CLAN | </i><i class="team-intro-heading-2">Overwatch</i></h1>
            <p class="team-intro-text">This is some filler text for the Overwatch team.  I'd actually prefer that someone else write this because I'm not too sure what to say about the team, though I could probably come up with some generic copy if I had to.  Someone has to!  So what should go here?  Here's some example text from another e-sports website:
            <br><br>
            ...
            <div class='row players-row'>                
                <div class='col-sm-6 player-col'>
                    <a class='player-link' href='player-profiles/Hanzo-profile.php'>
                        <div class='img-txt-cont'>
                            <img src='img/team-members/Member_Calling_Card_Hanzo3.png' class='player-image img-fluid'>
                ...
                <div class='col-sm-6 player-col'>
                    <a class='player-link' href='player-profiles/Re-Call-profile.php'>
                        <div class='img-txt-cont'>
        ...
        <div class='container' id='explore-cont'>
            <div class='row' id='explore-row'>
                <div class='col-4 explore-col'>
                    <a href='ssb.php' class='explore-link'><h2>Super Smash Bros</h2></a>
                </div>
